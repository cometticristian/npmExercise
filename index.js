...
http.createServer((req, res) => {
	...
	switch (req.url) {
		...
		case '/':
            ...
            console.log(' ');
            console.log('Título​: ​Bienvenidos a DH Movies el mejor sitio para encontrar las mejores películas, incluso mucho mejor que Netflix, Cuevana y PopCorn​.');
            console.log(' ');
            console.log('Total de películas en cartelera​: ' + movies.length);
            let titulosOrdenados = [];
            for (let i = 0; i < movies.length; i++) {
                
                let titulos = movies[i].title;
                titulosOrdenados.push(titulos);
            
            }
            console.log(' ');
            console.log('Listado de Peliculas.');
            console.log(' ');
            console.log(titulosOrdenados.sort());
            console.log(' ');
            console.log('Pié de página​.');
            console.log(' ');
		...
		case '/en-cartelera':
            ...
            console.log(' ');
            console.log('Título​: ​En Cartelera.');
            console.log(' ');
            console.log('Total de peliculas: ' + movies.length);
            console.log(' ');
            for (let i = 0; i < movies.length; i++) {
                console.log(' ');
                console.log('Titulo: ' + movies[i].title);
                console.log(' ');
                console.log('Reseña: ' + movies[i].overview);
                console.log(' ');
            }
            ...
            function promedioMejores (array) {
            ...
            return total * contarMejores(movies) / 100;
            }
            console.log(' ');
            console.log('Rating promedio: ' + promedioMejores(mejoresPromedios));
            for (let i = 0; i < movies.length; i++) {
                    
                    let average = movies[i].vote_average;
                    if (average >= 7) {
                        mejoresEnteras.push(movies[i]);
                    }
        ...
        case '/sucursales':
            ...
            console.log(' ');
            console.log('Título​: ​Nuestras Salas.');
            console.log(' ');
            console.log('Total de salas: ' + theaters.length);
            console.log(' ');
            ...
            for (let i = 0; i < theaters.length; i++) {
                ...
                console.log('');
                console.log(theaters[i].address);
                console.log('');
                console.log(theaters[i].description);
                console.log('');
            }
		...
		case '/contacto':
            ...
            console.log(' ');
            console.log('Título​: ​Contáctanos.');
            console.log(' ');
            console.log('Contenido​: ​¿Tenés algo para contarnos? Nos encanta escuchar a nuestros clientes. Si deseas contactarnos podés escribirnos al siguiente email: dhmovies@digitalhouse.com o en las redes sociales. Envianos tu consulta, sugerencia o reclamo y será respondido a la brevedad posible. Recordá que también podes consultar la sección de Preguntas Frecuentes para obtener respuestas inmediatas a los problemas más comunes.');
		...
		case '/preguntas-frecuentes':
            ...
            console.log('');
            console.log('Título​: ​Preguntas Frecuentes.');
            console.log('');
            console.log('Total de preguntas​: ' + faqs.length);
            console.log('');
            console.log('Listados de preguntas.');
            for (let i = 0; i < faqs.length; i++) {
                console.log('');
                console.log(faqs[i].faq_title);
                console.log('');
                console.log(faqs[i].faq_answer);
                console.log('');
            }
